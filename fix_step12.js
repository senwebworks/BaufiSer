...
const cleanStep12 = `                        <!-- Step 12: Prüfung starten -->
...
files.forEach(f => {
    try {
        ...
        const startMarker = '<!-- Step 12: Prüfung starten -->';
        const endMarker = '<div class="success-content">';
        
        const startIndex = html.indexOf(startMarker);
        const endIndex = html.indexOf(endMarker);
        
        if (startIndex !== -1 && endIndex !== -1) {
            html = html.substring(0, startIndex) + cleanStep12 + '                            ' + html.substring(endIndex);
